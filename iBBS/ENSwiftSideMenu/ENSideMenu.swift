...
@objc public protocol ENSideMenuProtocol {
    ...
    func dismissViewOpen()
    func dismissViewClose()
...
extension UIViewController {
    ...
    public func toggleSideMenuView () {
        ...
        if isSideMenuOpen() {
            ...
            sideMenuController()?.dismissViewClose()
        }
    }
...
public class ENSideMenu : NSObject, UIGestureRecognizerDelegate {
    ...
    private func toggleMenu (shouldOpen: Bool) {
        ...
        if (shouldOpen) {
            ...
            menuViewController.sideMenuController()?.dismissViewOpen()

            
        } else {
            delegate?.sideMenuWillClose?()
            menuViewController.sideMenuController()?.dismissViewClose()
